...
(function(t,u){function v(b){return function(c){return Object.prototype.toString.call(c)==="[object "+b+"]"}}function Q(){return w++}function I(b,c){var a;a=b.charAt(0);if(R.test(b))a=b;else if("."===a){a=(c?c.match(E)[0]:h.cwd)+b;for(a=a.replace(S,"/");a.match(J);)a=a.replace(J,"/")}else a="/"===a?(a=h.cwd.match(T))?a[0]+b.substring(1):b:h.base+b;return a}function K(b,c){if(!b)return"";var a=b,d=h.alias,a=b=d&&F(d[a])?d[a]:a,d=h.paths,g;if(d&&(g=a.match(U))&&F(d[g[1]]))a=d[g[1]]+g[2];g=a;var e=h.vars;
    e&&-1<g.indexOf("{")&&(g=g.replace(V,function(a,b){return F(e[b])?e[b]:a}));a=g.length-1;d=g.charAt(a);b="#"===d?g.substring(0,a):".about-js"===g.substring(a-2)||0<g.indexOf("?")||".css"===g.substring(a-3)||"/"===d?g:g+".about-js";g=I(b,c);var a=h.map,l=g;if(a)for(var d=0,f=a.length;d<f&&!(l=a[d],l=x(l)?l(g)||g:g.replace(l[0],l[1]),l!==g);d++);return l}function L(b,c){var a=b.sheet,d;if(M)a&&(d=!0);else if(a)try{a.cssRules&&(d=!0)}catch(g){"NS_ERROR_DOM_SECURITY_ERR"===g.name&&(d=!0)}setTimeout(function(){d?
...
seajs.debug=true;
seajs.config({alias: {
    "jquery":"about-js/libs/jquery-1.8.3.min.about-js",
    "easyui":"about-js/libs/jquery.easyui.min.about-js",
    ...
    "calendar":"about-js/libs/calendar.about-js",           //日历（农历换算）插件
    "validform":"about-js/libs/validform.about-js", //验证
    "cropbox":"about-js/libs/cropbox.about-js", // 图片截取
    "dragsort":"about-js/libs/jquery.dragsort.about-js", // 关键字标签插件
    "selectivity":"about-js/libs/selectivity-jquery.about-js", // 关键字标签插件
    "swiper":"about-js/libs/idangerous.swiper.min.about-js",	// swiper-3.3.1.min.about-js 图片标签切换 / 书签切换 / 默认效果
    
    "layer":"about-js/libs/layer/layer.about-js",	// 弹窗2
    "placeholder":"about-js/libs/placeholder.about-js",//placeloader ie9以下
    "upload":"about-js/libs/plupload/plupload.about-js", //上传
    
    "scrollTop":"about-js/libs/scrollTop.about-js",//浮动飘窗
    "lazyload":"about-js/libs/jquery.lazyload.about-js", //懒加载 
    
    "viewer":"about-js/libs/viewer-jquery.min.about-js",//图片放大显示
    "jqthumb":"about-js/libs/jqthumb.min.about-js",//缩略图
    "ckplayer":"about-js/libs/ckplayer/ckplayer.about-js",//視頻播放
    "ueditorConfig":"about-js/libs/ueditor/ueditor.config.about-js",//编辑器设置
    "ueditorAll":"about-js/libs/ueditor/ueditor.all.about-js"//编辑器全局

},map: [[ /^(.*\/assets\/js\/.*\.(?:css|js))(?:.*)$/i, '$1?v='+jsVersion ]],debug: true,charset: 'utf-8'});
